...
# --- הזרקת CSS ו-HTML לכפתורים לחיצים ---
st.markdown("""
    <style>
...
if st.button(" ", key="settings_trigger"):
    show_settings()
